...
import { FiGithub, FiLinkedin, FiMail, FiLayout } from "react-icons/fi";
...
export default function Header(_props: HeaderProps) {
  ...
  return (
    <header className={styles.header}>
      ...
      <nav ref={Menu} id="MENU" data-visible="false">
        <Logo />
        <ul className={styles.navigation}>
          ...
          />
          <ListItem
            href="mailto:brahmbir68@gmail.com"
            icon={<FiMail />}
            title="email"
          />
        </ul>
